y <-values <- c(24, 34)                                                          ##### Assigned Values
...
legend("topright",                                                               ##### Legend/Key
       legend = c("A: Test Group A Build 1", "B: Test Group A Build 2"),
       fill = c("#ff0000", "#00ffff"))

#####a <- c (2, 1, 2, 1, 2, 2, 1, 3, 1, 2, 0, 2, 0, 2, 0, 1, 0, 2)               ##### Box Plot values
#####b <- c (3, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 0, 3, 1, 2)               ##### Box Plot values
